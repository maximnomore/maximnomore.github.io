class ClockArrowsView {
  ...
  constructor(context, options = {}) {
    const defaultOptions = {
      arrowsLineCap: 'round',
      arrowsShadowColor: 'rgba(0, 0, 0, 0.5)',
      arrowsShadowBlur: 10,
      arrowsShadowOffsetX: 4,
      arrowsShadowOffsetY: 4,
      arrowHoursColor: 'rgba(25, 25, 25, 0.7)',
      arrowHoursWidth: 18,
      arrowHoursOffset: 100,
      arrowMinutesColor: 'rgba(25, 25, 25, 0.7)',
      arrowMinutesWidth: 10,
      arrowMinutesOffset: 60,
      arrowSecondsColor: 'rgba(220, 220, 220, 0.7)',
      arrowSecondsWidth: 2,
      arrowSecondsOffset: 50,
      arrowsCenterColor: 'rgba(220, 220, 220, 1)',
    };
  ...
  drawArrowSeconds(date) {
    ...
    {
      document.querySelector('.text').classList.remove('none');
    }
